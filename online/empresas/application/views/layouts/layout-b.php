		...
		<?php if(isset($sidebarActive) && $sidebarActive){?>
			...
			<div class="aviso elem-hidden">
				...
				<div id="widget-info-2">					
					A partir del 1 de enero de 2017 se ajustará a Bs. 5.000 el cobro mínimo mensual a aquellas facturas cuyo Servicio Administrativo
					sea inferior a esa cantidad y la tarifa mensual por concepto de Servicios Operativos y de Logística será de Bs. 3.000, quedando
					exceptuadas aquellas facturas con Servicio Administrativo Mínimo.
				</div>
			</div>
			<?php } ?>
