...
<div id="campos-config-descarga">
    ...
    <div id="campos-descarga">
        <a href="<?= get_cdn() ?>downloads/<?php  echo $pais == 'Ve' ? 'TV-MUS-002-conexion-empresas-online-V13.pdf' : 'TV-MUS-002-conexion-empresas-online-V10.pdf'   ?>" target="_blank">
		    <span>
			    <p id="first">Manual de Usuario Conexión Empresas Online (.pdf)</p>
			</span>
            <button id='manual_usuario'><span aria-hidden="true" class="icon" data-icon="&#xe02e;"></span></button>
        </a>
    </div>
    <?php
        if($pais!='Ve'):
    ...
    ?>
        <div id="campos-descarga">
            <a href="<?php echo get_cdn() ?>downloads/TP-MUS-002_gestor_lotes_V_1.pdf" target="_blank">
                ...
                <button id='manual_GL'><span aria-hidden="true" class="icon" data-icon="&#xe02e;"></span></button>
            </a>
        </div>
        <?php
            endif;
        ...
        <div id="campos-descarga">
            <a href="<?php echo get_cdn() ?>downloads/Gestor.rar">
                ...
                <button id='gestor_lotes'><span aria-hidden="true" class="icon" data-icon="&#xe06e;"></span></button>
            </a>
        </div>
        <?php
            endif;
    ...
    <?php
        ...
        if ($pais == 'Co'):
    ?>
    <div id="datos-1"><p id="user-name">Archivos de gestión Conexión Empresas Online</p>
    </div>
    <div id="campos-descarga">
        <a href="<?php echo get_cdn() ?>downloads/ArchivosLotes.rar">
                <span>
                    <p id="first">Archivos lotes operativos (.xls 194kb)</p>
                </span>
            <button id='archivos-xls'><span aria-hidden="true" class="icon" data-icon="&#xe05a;"></span></button>
        </a>
    </div>
    <?php
        endif;
    ...
    ?>
        ...
        <div id="campos-descarga">
            <a href="<?php echo get_cdn() ?>downloads/Archivo_Lote_Guarderia.xls">
                ...
                <button id='lote-guarderia'><span aria-hidden="true" class="icon" data-icon="&#xe05a;"></span></button>
            </a>
        </div>
        <div id="campos-descarga">
            <a href="<?php echo get_cdn() ?>downloads/Generador_Lotes.xlsm">
                ...
                <button id='gestor_lotes'><span aria-hidden="true" class="icon" data-icon="&#xe05a;"></span></button></a>
        </div>
    <?php
        endif;
    ?>
