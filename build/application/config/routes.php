...
//Information
$route['(bpi|co|pe|us|ve|ven)/benefits'] = "Novo_Information/benefitsInf";
$route['(bpi|co|pe|us|ve|ven)/terms'] = "Novo_Information/terms";
$route['(bpi|co|pe|us|ve|ven)/rates'] = "Novo_Information/ratesInf";
//Business
