...
defined('SINGLE_SIGNON_GET')  or define('SINGLE_SIGNON_GET', in_array(CUSTOMER_URI, ['bdb', 'bog']));
defined('SINGLE_SIGNON_POST') or define('SINGLE_SIGNON_POST', in_array(CUSTOMER_URI, ['bdb', 'bog', 'bnt']));
defined('ENGLISH_ACTIVE')     or define('ENGLISH_ACTIVE', in_array(CUSTOMER_URI, ['vg']));
