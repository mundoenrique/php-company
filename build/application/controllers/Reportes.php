  ...
  public function gastosporcategorias($urlCountry)
  {
    ...
    if ($paisS == $urlCountry && $logged_in && $moduloAct !== false) {
      ...
      $content = $this->parser->parse(
        'reportes/content-gastos-por-categoria',
        array(
          'titulo' => $nombreCompleto,
          'breadcrum' => '',
          'lastSession' => $lastSessionD,
  ...
  public function guarderia($urlCountry)
  {
    ...
    if ($paisS == $urlCountry && $logged_in && $moduloAct !== false) {
      ...
      $header = $this->parser->parse(
        ...
        array(
          'bodyclass' => '', 'menuHeaderActive' => TRUE, 'menuHeaderMainActive' => TRUE,
          'menuHeader' => $menuHeader, 'titlePage' => $titlePage
        ),
        TRUE
      );
      ...
      $sidebarLotes = $this->parser->parse(
        'widgets/widget-publi-4',
        array('sidebarActive' => TRUE),
        TRUE
      );
