...
class Lotes extends CI_Controller {
	...
	public function pantallaCarga($urlCountry)
	{
		...
		if($paisS==$urlCountry && $logged_in && $idProductoS && $moduloAct!==false){
			...
			$FooterCustomInsertJS=["jquery-3.4.0.min.js", "jquery-ui-1.12.1.min.js","jquery-md5.js","jquery.balloon.min.js","jquery.fileupload.js","jquery.iframe-transport.js","aes.min.js","aes-json-format.min.js","dashboard/widget-empresa.js","lotes/lotes.js","jquery.dataTables.min.js","header.js","routes.js"];
			$FooterCustomJS="";
	...
	*/
	public function pantallaAutorizacion($urlCountry)
	{
		...
		if($paisS==$urlCountry && $logged_in && $idProductoS && $linkAut!==false){
			...
			$nombreCompleto = $this->session->userdata('nombreCompleto');
			$lastSessionD = $this->session->userdata('lastSession');
			$FooterCustomInsertJS=["jquery-3.4.0.min.js", "jquery-ui-1.12.1.min.js","jquery.balloon.min.js","jquery-md5.js","dashboard/widget-empresa.js","lotes/lotes-autorizacion.js","jquery.dataTables.min.js","header.js","routes.js"];
			$FooterCustomJS="";
			$titlePage="Conexión Empresas Online - Lotes";
