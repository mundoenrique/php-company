...
<nav class="navbar-secondary line-main-nav flex bg-secondary items-center">
	<ul class="main-nav-user flex my-0 list-style-none">
		<li class="nav-item mr-1 pr-2">
			<a class="nav-link semibold primary" href="ceo_dashboard.html">Inicio</a>
		</li>
		<li class="nav-item mr-1 px-2">
      <a class="nav-link semibold primary">Lotes</a>
    ...
    <li class="nav-item mr-1 px-2">
			<a class="nav-link semibold primary">Consulta</a>
			<ul class="dropdown-user pl-0 regular tertiary bg-secondary list-style-none list-inline">
        <li><a class="px-2" href="ceo_service_orders.html">Órdenes de servicio</a></li>
      </ul>
    </li>
    <li class="nav-item mr-1 px-2">
      <a class="nav-link semibold primary">Reportes</a>
      <ul class="dropdown-user pl-0 regular tertiary bg-secondary list-style-none list-inline">
