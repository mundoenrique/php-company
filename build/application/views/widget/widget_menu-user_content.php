...
<nav id="account-nav">
	<ul class="menu">
		<?php if( $settingContents['widget_menu-user']['menuTop'] === 'unique' ): ?>
			<li class="menu-item settings">
				...
				<ul class="submenu">
					...
					<li class="menu-item signout">
						<a id='subm-desc' rel="subsection" href="<?=  $urlRedirect.'2' ?>"> <!-- $tab -->
		...
		<?php else: ?>
			<?php if( $settingContents['widget_menu-user']['menuTop'] === 'extended' ): ?>
