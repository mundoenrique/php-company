        ...
        <form id="form-report" method="post" class="reports-form w-100 none" onsubmit="return false">
          <div id="repMovimientoPorEmpresa" class="row">
            <div class="form-group col-4">
              ...
              <input id="enterpriseDateBegin" class="form-control date-picker" name="datepicker_start" type="text" readonly placeholder="DD/MM/AAAA" disabled>
              <div class="help-block"></div>
            </div>
            <div class="form-group col-4">
              <label for="enterpriseDateEnd"><?= lang('GEN_END_DAY'); ?></label>
              <input id="enterpriseDateEnd" class="form-control date-picker" name="datepicker_end" type="text" readonly placeholder="DD/MM/AAAA" disabled>
              <div class="help-block"></div>
            </div>
          ...
          <div id="repMovimientoPorTarjeta">
            <div id="MovimientoPorTarjeta">
              ...
              <div id="sectionByCard" class="row none">
                ...
                <div class="form-group col-3">
                  ...
                  <input id="cardDateBegin" class="form-control date-picker-card" name="datepicker_start" type="text" readonly placeholder="<?= lang('GEN_PLACE_DATE_COMPLETTE'); ?>" disabled>
                  <div class="help-block"></div>
                </div>

                <div class="form-group col-3">
                  <label for="cardDateEnd"><?= lang('GEN_END_DAY'); ?></label>
                  <input id="cardDateEnd" class="form-control date-picker-card" name="datepicker_end" type="text" readonly placeholder="<?= lang('GEN_PLACE_DATE_COMPLETTE'); ?>" disabled>
                  <div class="help-block"></div>
                </div>
            ...
            <div id="result-repMovimientoPorTarjeta" class="row none">
              ...
              <div class="form-group col-3">
                ...
                <input id="peopleDateBegin" class="form-control date-picker-card" name="datepicker_start" type="text" readonly placeholder="<?= lang('GEN_PLACE_DATE_COMPLETTE'); ?>" disabled>
                <div class="help-block"></div>
              </div>

              <div class="form-group col-3">
                <label for="peopleDateEnd"><?= lang('GEN_END_DAY'); ?></label>
                <input id="peopleDateEnd" class="form-control date-picker-card" name="datepicker_end" type="text" readonly placeholder="<?= lang('GEN_PLACE_DATE_COMPLETTE'); ?>" disabled>
                <div class="help-block"></div>
              </div>
          ...
          <div id="repComprobantesVisaVale" class="row .repComprobantes">
            <div class="form-group col-6 col-lg-4">
              ...
              <input id="date" class="form-control month-year" name="selected-date" type="text" readonly placeholder="<?= lang('GEN_PLACE_DATE_MEDIUM') ?>" disabled>
              <div class="help-block"></div>
            </div>
          ...
          <div id="repExtractoCliente" class="row">
            <div class="form-group col-6 col-lg-4">
              <label for="datepicker"><?= lang('GEN_TABLE_DATE') ?></label>
              <input id="dateEx" class="form-control month-year" name="selected-date" type="text" readonly placeholder="<?= lang('GEN_PLACE_DATE_MEDIUM') ?>" disabled>
              <div class="help-block"></div>
            </div>
          ...
          <div id="repCertificadoGmf" class="row" firts-year="<?= $mindateGmfReport; ?>">
            ...
            <div class="form-group col-3 col-lg-4">
              ...
              <input id="dateG" class="form-control year" name="selected-year" type="text" readonly placeholder="<?= lang('GEN_PLACE_DATE_SHORT') ?>" disabled>
              <div class="help-block"></div>
            </div>
