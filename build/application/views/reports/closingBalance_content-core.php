            ...
            <div class="row flex flex items-center justify-start col-sm-12">
              <div class="form-group <?= lang('SETT_SETT_STYLE_SKIN') ?>">
                ...
                <select id="enterpriseReport" name="enterpriseReport" class="select-box custom-select mt-1 mb-1 h6 w-100">
                  ...
                  <?php endif;?>
                  <option code="<?= $enterprise->accodcia; ?>" group="<?= $enterprise->accodgrupoe; ?>" nomOf="<?= $enterprise->acnomcia; ?>"
                    acrif="<?= $enterprise->acrif; ?>" value="<?= $enterprise->accodcia; ?>"
                    <?= $enterprise->acrif == $enterpriseData->idFiscal ? 'selected' : '' ?>>
                    <?= $enterprise->acnomcia; ?>
                  </option>
                  <?php endforeach; ?>
                </select>
              ...
              <div class="form-group <?= lang('SETT_SETT_STYLE_SKIN') ?>">
                ...
                <input id="document" class="form-control h5" name="document" placeholder="<?= lang('REPORTS_ID_FISCAL_INPUT') ?>">
                <div class="help-block"></div>
              </div>
              <?php endif; ?>
