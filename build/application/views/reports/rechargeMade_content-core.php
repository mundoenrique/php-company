    ...
    <div class="flex flex-auto flex-column <?= $widget ? '' : 'max-width-6'; ?>">
      <div class="search-criteria-order flex pb-3 flex-column w-100">
        ...
        <div class="flex my-2 px-5">
          <form id="recharge-made-form" action="<?= base_url(lang('SETT_LINK_RECHARGE_MADE')); ?>" method="post" class="w-100">
            <div class="row flex justify-between">
              ...
              <div class="form-group col-4 col-lg-3 col-xl-3">
                ...
                <input id="initialDatemy" name="initialDatemy" class="form-control" name="datepicker" type="text" placeholder="<?= lang('GEN_PLACE_DATE_MEDIUM'); ?>" readonly>
          ...
          <div class="center mx-1">
            <div class="flex">
              <div class="flex mr-2 py-3 flex-auto justify-end items-center download">
                ...
                <form id="download-rechargemade" action="<?= base_url(lang('SETT_LINK_DOWNLOAD_FILES')); ?>" method="post"></form>
              </div>
            </div>
