					...
					<div class="flex my-2 px-5">
						<form id="limitsForm" class="w-100">
								<div class="row flex justify-between">
									...
									<input id="cardNumber" name="card-number" class="form-control h5 select-group" type="text" autocomplete="off" disabled  value="4189281080002216">
											...
											<div class="row">
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="numberDayPurchasesCtp" class="money form-control pwd-input text-right"  type="text" autocomplete="off" name="numberDayPurchasesCtp"  disabled>
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="numberWeeklyPurchasesCtp" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="numberWeeklyPurchasesCtp"  disabled >
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="numberMonthlyPurchasesCtp" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="numberMonthlyPurchasesCtp"  disabled>
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="dailyPurchaseamountCtp" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="dailyPurchaseamountCtp"  disabled>
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="weeklyAmountPurchasesCtp" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="weeklyAmountPurchasesCtp"  disabled>
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="monthlyPurchasesAmountCtp" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="monthlyPurchasesAmountCtp"  disabled>
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="purchaseTransactionCtp" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="purchaseTransactionCtp"  disabled>
													</div>
													<div class="help-block"></div>
												</div>
											</div>
										...
										<div class="col-10 bolck mx-auto">
											<div class="row">
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="numberDayPurchasesStp" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="numberDayPurchasesStp"  disabled>
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="numberWeeklyPurchasesStp" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="numberWeeklyPurchasesStp"  disabled>
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="numberMonthlyPurchasesStp" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="numberMonthlyPurchasesStp"  disabled>
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="dailyPurchaseamountStp" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="dailyPurchaseamountStp"  disabled>
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="weeklyAmountPurchasesStp" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="weeklyAmountPurchasesStp"  disabled>
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="monthlyPurchasesAmountStp" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="monthlyPurchasesAmountStp"  disabled>
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="purchaseTransactionStp" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="purchaseTransactionStp"  disabled>
													</div>
													<div class="help-block"></div>
												</div>
											</div>
										...
										<div class="col-10 bolck mx-auto">
											<div class="row">
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="dailyNumberWithdraw" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="dailyNumberWithdraw"  disabled>
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="weeklyNumberWithdraw" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="weeklyNumberWithdraw"  disabled>
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="monthlyNumberWithdraw" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="monthlyNumberWithdraw"  disabled>
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="dailyAmountWithdraw" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="dailyAmountWithdraw"  disabled>
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div clxs="input-group">
														<input id="weeklyAmountWithdraw" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="weeklyAmountWithdraw"  disabled>
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="monthlyAmountwithdraw" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="monthlyAmountwithdraw"  disabled>
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="WithdrawTransaction" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="WithdrawTransaction"  disabled>
													</div>
													<div class="help-block"></div>
												</div>
											</div>
										...
										<div class="col-10 bolck mx-auto">
											<div class="row">
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="dailyNumberCredit" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="dailyNumberCredit"  disabled>
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="weeklyNumberCredit" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="weeklyNumberCredit"  disabled>
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="monthlyNumberCredit" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="monthlyNumberCredit"  disabled>
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="dailyAmountCredit" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="dailyAmountCredit"  disabled>
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div clxs="input-group">
														<input id="weeklyAmountCredit" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="weeklyAmountCredit"  disabled>
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="monthlyAmountCredit" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="monthlyAmountCredit"  disabled>
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="CreditTransaction" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="CreditTransaction"  disabled>
													</div>
													<div class="help-block"></div>
												</div>
											</div>
