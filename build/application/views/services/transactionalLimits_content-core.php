											...
											<div class="row">
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="numberDayPurchasesCtp" class="money form-control pwd-input text-right"  type="text" autocomplete="off" name="numberDayPurchasesCtp"  disabled maxlength="9">
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="numberWeeklyPurchasesCtp" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="numberWeeklyPurchasesCtp"  disabled maxlength="9">
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="numberMonthlyPurchasesCtp" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="numberMonthlyPurchasesCtp"  disabled maxlength="9">
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="dailyPurchaseamountCtp" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="dailyPurchaseamountCtp"  disabled maxlength="9">
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="weeklyAmountPurchasesCtp" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="weeklyAmountPurchasesCtp"  disabled maxlength="9">
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="monthlyPurchasesAmountCtp" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="monthlyPurchasesAmountCtp"  disabled maxlength="9">
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="purchaseTransactionCtp" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="purchaseTransactionCtp"  disabled maxlength="9">
													</div>
													<div class="help-block"></div>
												</div>
											</div>
										...
										<div class="col-10 bolck mx-auto">
											<div class="row">
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="numberDayPurchasesStp" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="numberDayPurchasesStp"  disabled maxlength="9">
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="numberWeeklyPurchasesStp" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="numberWeeklyPurchasesStp"  disabled maxlength="9">
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="numberMonthlyPurchasesStp" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="numberMonthlyPurchasesStp"  disabled maxlength="9">
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="dailyPurchaseamountStp" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="dailyPurchaseamountStp"   disabled maxlength="9">
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="weeklyAmountPurchasesStp" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="weeklyAmountPurchasesStp"  disabled maxlength="9">
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="monthlyPurchasesAmountStp" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="monthlyPurchasesAmountStp"  disabled maxlength="9">
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="purchaseTransactionStp" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="purchaseTransactionStp"  disabled maxlength="9">
													</div>
													<div class="help-block"></div>
												</div>
											</div>
										...
										<div class="col-10 bolck mx-auto">
											<div class="row">
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="dailyNumberWithdraw" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="dailyNumberWithdraw"  disabled maxlength="9">
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="weeklyNumberWithdraw" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="weeklyNumberWithdraw"  disabled maxlength="9">
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="monthlyNumberWithdraw" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="monthlyNumberWithdraw"  disabled maxlength="9">
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="dailyAmountWithdraw" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="dailyAmountWithdraw"  disabled maxlength="9">
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div clxs="input-group">
														<input id="weeklyAmountWithdraw" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="weeklyAmountWithdraw"  disabled maxlength="9">
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="monthlyAmountwithdraw" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="monthlyAmountwithdraw"  disabled maxlength="9">
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="WithdrawTransaction" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="WithdrawTransaction"  disabled maxlength="9">
													</div>
													<div class="help-block"></div>
												</div>
											</div>
					...
					<div class="flex mb-5 flex-column ">
										...
										<div class="col-10 bolck mx-auto">
											<div class="row">
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="dailyNumberCredit" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="dailyNumberCredit"  disabled maxlength="9">
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="weeklyNumberCredit" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="weeklyNumberCredit"  disabled maxlength="9">
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="monthlyNumberCredit" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="monthlyNumberCredit"  disabled maxlength="9">
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="dailyAmountCredit" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="dailyAmountCredit"  disabled maxlength="9">
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div clxs="input-group">
														<input id="weeklyAmountCredit" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="weeklyAmountCredit"  disabled maxlength="9">
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="monthlyAmountCredit" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="monthlyAmountCredit"  disabled maxlength="9">
													</div>
													<div class="help-block"></div>
												</div>
												<div class="form-group col-12 col-lg-4">
													...
													<div class="input-group">
														<input id="CreditTransaction" class="money form-control pwd-input text-right" type="text" autocomplete="off" name="CreditTransaction"  disabled maxlength="9">
													</div>
													<div class="help-block"></div>
												</div>
											</div>
						...
						<div class="flex row mt-3 mb-2 mx-2 justify-end">
							<div class="col-5 col-lg-3 col-xl-3 form-group">
								<div class="input-group">
									<input id="passwordAuth" name="password" class="form-control pwd-input pr-0" type="password" autocomplete="off" placeholder="Contraseña" disabled>
