                ...
                <div class="help-block"></div>
							...
							<div class="col-3 form-group mt-3 ml-auto">
								<div class="input-group">
									<input id="password-tranfer" name="password" class="form-control pwd-input pr-0 pwd" type="password" autocomplete="off" placeholder="<?= lang('GEN_PLACE_PASSWORD'); ?>" disabled>
