        ...
        <div class="flex pb-3 flex-column w-100">
          ...
          <div class="flex my-2 px-5">
            ...
            <form id="masterAccountRechargeForm" method="post" class="w-100">
              <p class="mr-5 mb-3 sh5 semibold tertiary"><?= $balanceText ?> <span id="master-balance-aviable" class="light text"><?= $balance; ?></span>
              ...
              <div class="row" id="recharge_account">
                ...
                <?php if (lang('SETT_SELECT_ACCOUNT') === 'ON') : ?>
                  <div class="form-group col-3">
                    ...
                    <input type="text" id="accountUser" name="accountUser" class="form-control px-1" value="<?= $fundingAccount; ?>" autocomplete="off" readonly disabled>
                ...
                <div class="form-group col-3">
                  ...
                  <input id="transferAmount" class="form-control h5 text-right" type="text" placeholder="<?= '0' . lang('SETT_DECIMAL') . '00'; ?>" name="transferAmount" autocomplete="off" disabled>
                  <div class="help-block"></div>
                </div>
                <?php if (lang('SETT_INPUT_DESCRIPTION') == 'ON') : ?>
                  <div class="form-group col-3">
                    <label for="description"><?= lang('GEN_DESCRIPTION'); ?></label>
                    <input id="description" class="form-control h5" type="text" placeholder="Ingresa descripción" name="description" autocomlpete="off" disabled>
                    <div class="help-block"></div>
                  </div>
                <?php endif; ?>
                <?php if (lang('SETT_REMOTE_AUTH') == 'OFF' && lang('SETT_INPUT_GET_TOKEN') == 'OFF') : ?>
                  <div class="col-3 form-group mt-3 ml-auto">
                    <div class="input-group">
                      <input id="passwordTranfer" name="password" class="form-control pwd-input pr-0 pwd" type="password" autocomplete="off" placeholder="<?= lang('GEN_PLACE_PASSWORD'); ?>" disabled>
              ...
              <div class="flex row mt-3 mb-2 mx-2 justify-end">
                <div class="col-3 col-lg-3 col-xl-3 form-group">
                  <?php if (lang('SETT_REMOTE_AUTH') == 'OFF') : ?>
                    <div class="input-group">
                      <input id="passAction" name="password" class="form-control pwd-input pr-0 pwd" type="password" autocomplete="off" placeholder="<?= lang('GEN_PLACE_PASSWORD'); ?>">
                      <div class="input-group-append">
