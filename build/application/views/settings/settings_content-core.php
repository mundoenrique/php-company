								...
								<form id="formChangeEmail">
									...
									<div class="row">
										<div class="col-6 flex justify-end">
											<button id="btnChangeEmail" class="btn btn-primary btn-small btn-loading" type="submit"><?= lang('GEN_BTN_ACCEPT') ?></button>
										</div>
									</div>
								</form>
							</div>
							...
							<div class="section my-2 px-5">
								<form id="passwordChangeForm">
									...
									<div class="container">
										...
										<div class="row">
											<div class="col-6 flex justify-end">
												<button id="passwordChangeBtn" class="btn btn-primary btn-small btn-loading" type="button"><?= lang('GEN_BTN_ACCEPT') ?></button>
											</div>
										</div>
									</div>
								</form>
									...
									<form id="enterpriseDataForm">
										...
										<div class="row">
											<div class="form-group mb-3 col-6 col-lg-4 col-xl-4">
												...
												<input type="text" id="phone1" name="phone1" class="form-control" value="<?= $phone1; ?>" maxlength="15">
												<div class="help-block"></div>
											</div>
											<div class="form-group mb-3 col-6 col-lg-4 col-xl-4">
												<label for="phone2">Teléfono 2</label>
												<input id="phone2" name="phone2" class="form-control" value="<?= $phone2; ?>" maxlength="15">
												<div class="help-block"></div>
											</div>
											<div class="form-group mb-3 col-6 col-lg-4 col-xl-4">
												<label for="phone3">Teléfono 3</label>
												<input id="phone3" name="phone3" class="form-control" value="<?= $phone3; ?>" maxlength="15">
												<div class="help-block"></div>
											</div>
										</div>
										<div class="row">
