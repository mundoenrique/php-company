	...
	<div class="row justify-center">
		<div class="col-auto px-0">
			<div class="flex flex-column items-center z1 h-100">
				<img class="logo-banco mb-2" src="<?= $this->asset->insertFile(lang('GEN-LOGO-BIG'), 'images', $customerLang); ?>"
		...
		<div class="col-auto px-0">
			<div class="h-100">
				<div class="flex pr-2 pr-lg-0 img-log h-100">
					<img src="<?= $this->asset->insertFile(lang('GEN_IMAGE_LOGIN'), 'images', $customerLang); ?> " alt="Imagen de referencia">
				</div>
			</div>
		</div>
		<?php endif; ?>
