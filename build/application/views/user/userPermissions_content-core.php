            ...
            <div class="row mx-3">
              <div class="form-group custom-control custom-switch col-6 col-lg-4 pb-3 my-3">
                ...
                <label class="include custom-control-label semibold"
                  for="allPermits"><?= lang('PERMITS_ALL_PERMITS'); ?></span>
                </label>
              </div>
              <div class="form-group custom-control custom-switch col-6 col-lg-4 pb-3 my-3">
                <input id="removeAllPermissions" class="custom-control-input" type="checkbox"
                  name="removeAllPermissions" value="off">
                <label class="include custom-control-label semibold"
                  for="removeAllPermissions"><?= lang('PERMITS_DELETE_ALL_PERMITS'); ?></span>
                </label>
              </div>
            </div>
            ...
            <form id="checkFormPermits">
              ...
              <div class="row mx-3 mb-1">
                ...
                <div class="form-group custom-control custom-switch col-4 col-lg-3 pb-2">
                  <input id="<?=$subValue->accodfuncion ?>" class="permissions custom-control-input" type="checkbox"
              ...
              <div class="flex row mb-2 mx-2 items-center justify-end">
                ...
                <?php if ($username !== $user && $this->verify_access->verifyAuthorization('USEREM','ASGPER')): ?>
