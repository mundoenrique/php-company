		...
		<div id="widget-signin" class="widget tooltip">
			...
			<div class="widget-content">
				<form id="signInForm" name="signInForm" accept-charset="utf-8">
					...
					<input type="text" id="userName" name="userName" disabled autocomplete="user-name">
					<div class="form-group">
						<label for="userPass"><?= lang('GEN_PASSWORD'); ?></label>
						<input type="password" id="userPass" name="userPass" disabled autocomplete="user-password">
