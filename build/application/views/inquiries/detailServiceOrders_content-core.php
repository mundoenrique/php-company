...
<div class="pt-3 px-5 pb-5">
  ...
  <span class="ml-2 regular tertiary"><?= lang('GEN_PREPAID_B_BOGOTA'); ?></span>
	...
	<div class="flex tertiary">
		<nav class="main-nav nav-inferior">
			<ul class="mb-0 h6 light tertiary list-style-none list-inline">
				...
				<li class="inline"><a class="tertiary big-modal" href="<?= base_url('consulta-orden-de-servicio') ?>"><?= lang('GEN_MENU_CONS_ORDERS_SERV'); ?></a></li>/
				<li class="inline"><a class="tertiary not-pointer" href="javascript:"><?= lang('GEN_DETAIL_BULK_TITLE'); ?></a></li>
			</ul>
		</nav>
	</div>
</div>
    ...
    <div class="flex flex-auto flex-column">
      <div class="flex flex-column">
        ...
        <div class="row mb-2 px-5">
          ...
          <div class="form-group mb-3 col-4">
            <label for="regNumber" id="regNumber"><?= lang('GEN_STATUS'); ?></label>
