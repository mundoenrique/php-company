...
<div id="content-products">
  ...
  <div id="lotes-general">
        ...
        <form id="form-criterio-busqueda" onsubmit="return false">
          ...
          <div id="search-1">
            ...
            <span>
              ...
              <input id="EstatusLotes-fecha-in" class="required login fecha" type="text" name="start-dmy-date"
                placeholder="DD/MM/AA" value="" onFocus="javascript:this.value=''" />
            </span>
            <span>
              <p><?php echo lang('TITULO_REPORTES_FECHAFIN'); ?></p>
              <input id="EstatusLotes-fecha-fin" class="required login fecha" type="text" name="end-dmy-date"
                placeholder="DD/MM/AA" value="" onFocus="javascript:this.value=''" />
            </span>
          </div>
          <div id="search-2">
    ...
    <div id="cargando" style="display:none">
      <h2 style="text-align:center">Cargando Reporte</h2><img style="display:block; margin-left:auto; margin-right:auto"
