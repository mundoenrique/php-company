			...
			<div class="hide-out hide">
				<div class="row px-5">
					...
					<div class="form-group mb-3 col-4">
						...
						<span id="confirmName" class="form-control px-1 truncate" title="<?= $detailBulk->enterpriseName ?>" data-toggle="tooltip" readonly="readonly"><?= $detailBulk->enterpriseName ?></span>
					</div>
