...
$lang['WELCOME_MESSAGE']='Con este sistema las gestiones de pago de tu empresa son más eficientes, seguras y rápidas.<br>Empieza a disfrutar de todas las ventajas que te ofrece Conexión Empresas.';
...
$lang['INFO-1']='Teléfono: (57-1) 419-3333';
$lang['INFO-2']='Ventas: ventas@tebca.com.co / ventas@servitebca.com.co';
$lang['INFO-3']='Sugerencias: info@tebca.com.co / info@servitebca.com.co';
...
$lang['MSG_NEW_PASS_USER'] = 'Por motivos de seguridad es necesario que cambie su contraseña la primera vez que ingresa a nuestro sistema "Conexión Empresas".';
$lang['MSG_NEW_PASS_CADU'] = 'Clave vencida. Por motivos de seguridad es necesario que cambies tu contraseña antes de continuar en nuestro sistema "Conexión Empresas".';
...
// TAB USUARIO
$lang['INFO_USER_NAME'] = 'Nombre: ';
$lang['INFO_USER_APELLIDO'] = 'Apellido: ';
$lang['INFO_USER_CARGO'] = 'Cargo: ';
$lang['INFO_USER_AREA'] = 'Área: ';
$lang['INFO_USER_EMAIL'] = 'E-mail: ';
$lang['BOTON_MOD_USER'] = 'Modificar datos de usuario';
...
$lang['EMP_BTN_MODIF'] = 'Modificar datos empresa';
$lang['EMP_BTN_CONTACT'] = 'Mostrar contactos empresa';
$lang['EMP_BTN_ADD_CONTACT'] = 'Agregar';
...
// TAB SUCURSAL
$lang['SUC_TITLE'] = 'Configuración de sucursales';
$lang['SUC_EMP'] = 'Empresa';
$lang['SUC_NOMB'] = 'Nombre: ';
$lang['SUC_ZONA'] = 'Zona: ';
$lang['SUC_DIRECCION_1'] = 'Dirección 1:';
$lang['SUC_DIRECCION_2'] = 'Dirección 2: ';
$lang['SUC_DIRECCION_3'] = 'Dirección 3: ';
$lang['SUC_PAIS'] = 'País: ';
$lang['SUC_ESTADO'] = 'Departamento: ';
...
<p>
Al continuar y completar el proceso de inscripción y registro, habrá confirmado que revisó y acepta los términos y condiciones de este acuerdo. El acceso y uso de los canales electrónicos, constituye una confirmación adicional de su aceptación, sin limitación alguna, de los términos y condiciones aquí establecidos, así como de su futuro cumplimiento. Acepta además que todos los avisos o notificaciones futuras relacionadas con los canales electrónicos de Banco Pichincha C.A. podrán proveérsele de manera electrónica a su dirección de correo electrónico y/o su número de teléfono celular registrados. Por tanto, es de su exclusiva responsabilidad proveernos información de contacto correcta, conociendo y aceptando que Banco Pichincha C.A. no es responsable por inconvenientes o demoras en el acceso a los canales electrónicos, que sean causa de información de contacto incorrecta o imprecisa.
</p>
<p>
Adicionalmente, usted se compromete a cumplir con los términos y condiciones de todos los demás convenios suscritos con Banco Pichincha C.A., así como de las notificaciones recibidas que se relacionen con sus cuentas y otros servicios a los que pueda acceder por medio de los canales electrónicos de Banco Pichincha C.A.
</p>
<p>
...
<p>
A menos que se especifique lo contrario en este acuerdo, los siguientes términos serán usados conforme las definiciones generales aquí provistas:
</p>
<p>
a) “Cuentas”: Se refiere de manera general a cualquier tipo de relación financiera o comercial entre usted y Banco Pichincha C.A., que pueda gestionar a través de cualquiera de los canales electrónicos. Incluye, sin limitar, cuentas de ahorro, corrientes o básicas, préstamos personales, préstamos hipotecarios, préstamos de cualquier tipo, inversiones, tarjetas de crédito, tarjetas prepago, servicios financieros y/o cualquier otra relación financiera. La determinación de las Cuentas que se pueden gestionar a través de los canales electrónicos, es de exclusiva potestad de Banco Pichincha C.A., reservándose el derecho de modificar tales Cuentas en cualquier momento.
</p>
<p>
b) “Día Laborable”: Son todos los días del año, excepto los sábados, domingos y días feriados establecidos por la ley.
</p>
<p>
...
<p>
·	Consiento que todas las notificaciones relacionadas con el acceso y uso de los canales electrónicos, así como de los movimientos y transacciones que realice a través de ellos, sean entregados de manera electrónica por el mismo canal utilizado o a través de un mensaje de datos enviado al dispositivo móvil o dirección de correo electrónico que mantengo registrados en el Banco.
</p>
<h4>b. Derecho a revocar su consentimiento</h4>
<p>
Usted tendrá el derecho de revocar su consentimiento, en cuyo caso el Banco podría dejar de proveerle comunicaciones electrónicamente, e incluso, podría dar por terminado su acceso a los canales electrónicos. La revocación del consentimiento solo será efectiva una vez que nos haya comunicado su intención de revocarlo llamando a nuestro Call Center, y luego de que Banco Pichincha C.A. haya tenido un periodo de tiempo razonable para actuar sobre su revocación. Su consentimiento se mantendrá vigente hasta tanto no se haya revocado de la forma descrita en esta sección.
</p>
<h4>c. Notificación de cambios</h4>
<p>
Es su obligación mantener actualizados los datos personales proporcionados a Banco Pichincha C.A. e informarle de cualquier cambio, especialmente los relativos a dirección de domicilio, trabajo, correo electrónico y/o números telefónicos (celulares o de domicilio) de contacto.
</p>
<p>
En caso de que cambie su dirección de correo electrónico, número de teléfono celular o algún otro dato de contacto, deberá notificarlos inmediatamente, a través de los canales de Banco Pichincha C.A. puestos a su disposición.
</p>
<p>
Si dejara de actualizar o cambiara su dirección de correo electrónico u otra información de contacto, entiende y acepta que se considerarán las comunicaciones como enviadas a usted, siempre que dichas comunicaciones se hayan remitido a la dirección electrónica o número celular registrados en Banco Pichincha C.A.
</p>
<h4>d. Requerimientos de hardware y software</h4>
<p>
Antes de aceptar el envío de mensajes de datos a través de los canales electrónicos, debe verificar que cuenta con el hardware y el software necesarios para acceder a la información correspondiente en formato electrónico. Los requerimientos de hardware y software mínimos que necesitará son los siguientes:
</p>
<p>
•	Acceso a Internet a través de su proveedor de servicio móvil o mediante conexión WiFi segura.
</p>
<p>
•	Un equipo o dispositivo móvil con navegador de Internet, con sistemas operativos compatibles como iOS o Android (Smartphone).
</p>
<p>
•	Otros teléfonos sin capacidad de acceso a Internet, podrán acceder a una versión en texto únicamente (SMS y/o USSD).
</p>
<p>
Si usted no cuenta con las especificaciones antes mencionada, ya sea para su equipo o dispositivo móvil, el Banco no será responsable de la imposibilidad de brindar sus servicios por los canales electrónicos.
</p>
<p>
...
<p>
Con la suscripción del presente documento o con el registro de datos biométricos en cualquier canal electrónico de Banco Pichincha C.A., usted acepta que el Banco utilice dichos datos biométricos exclusivamente para brindar los servicios disponibles en cada plataforma o los solicitados por usted a través de dichos canales.
</p>
<p>
No comparta sus contraseñas o claves de seguridad con nadie y mantenga esa información en un lugar seguro, evitando que otros no puedan acceder a ella. Usted es responsable de mantener la confidencialidad de su usuario, de sus contraseñas y de sus Cuenta, así como de restringir el acceso a su equipo o dispositivo móvil. Por este acuerdo acepta y consiente que los firmantes autorizados a usar su Cuenta también estarán autorizados a usar los canales electrónicos para solicitar y aceptar Servicios o realizar transacciones relacionadas con ésta. Banco Pichincha C.A. no adquiere obligación alguna, expresa o implícita, de investigar si el uso de los canales electrónicos, o el acceso a ellos, fue llevado a cabo por la persona autorizada por usted o siguiendo las medidas de seguridad adoptadas por usted.
</p>
<p>
Al usar los canales electrónicos, lo hace conociendo que las transmisiones por Internet nunca son completamente privadas ni seguras, y que el nivel de seguridad de su equipo o dispositivo es su responsabilidad. Aunque Banco Pichincha C.A. toma medidas de seguridad estrictas para proteger el contenido de sus comunicaciones y datos confidenciales, el Banco no se hace responsable por cualquier ataque malicioso a la plataforma electrónica o al aplicativo instalado en su dispositivo que puedan poner en riesgo la seguridad de la información, si tales eventos estuvieran razonablemente fuera del alcance de los controles de seguridad de Banco Pichincha.
</p>
<p>
Si usted sospecha que el acceso a los canales electrónicos o a los Servicios ofrecido a través de ellos, ha sido comprometido y/o se percata de transacciones no autorizadas, es su responsabilidad cambiar su contraseña inmediatamente, a través de la opción dispuesta para ello en el aplicativo, y/o llamar al Call Center para recibir instrucciones adicionales. Como medida de seguridad adicional, Banco Pichincha C.A. podría requerirle que conteste algunas preguntas de desafío que refuercen la confirmación de su identidad, para permitirle el acceso al canal electrónico. En este acurdo y en los contratos de cuenta correspondientes encontrará información adicional relacionada con los procedimientos aplicables en caso de ocurrir transacciones no autorizadas.
</p>
<p>
...
<p>Los Servicios antes señalados pueden ser modificados en cualquier momento, de conformidad con las definiciones de Banco Pichincha C.A.</p>
<p>
Adicionalmente, se pueden incluir servicios de valor agregado, tales como noticias, servicio al cliente, búsquedas de puntos de atención georeferenciados, entre otros.
</p>
<p>
...
<p>
Sujeto a cualquier limitación expresada a continuación, contará con acceso a los canales electrónicos los siete (7) días de la semana, las veinticuatro (24) horas del día, excepto en momentos los que se realicen mantenimiento o actualizaciones a las plataformas tecnológicas. Usted acepta y acuerda que la disponibilidad y habilidad de Banco Pichincha C.A. para proveer acceso a los canales electrónicos dependerá de, entre otros factores, la disponibilidad y operación continua de la plataforma tecnológica, sistema computarizado y la línea de procesamiento de comunicaciones de Banco Pichincha C.A., así como de su proveedor de servicio de Internet, de su navegador, de su de su equipo o dispositivo de acceso y de las líneas telefónicas y/o eléctricas. En caso de que se interrumpiera temporalmente o cesara el acceso a los canales electrónicos por razones de fuerza mayor, como por ejemplo desastres naturales, u otra razón, Banco Pichincha C.A. no asumirá responsabilidad legal por tal interrupción. En las situaciones en que los canales electrónicos se interrumpan, podrá continuar efectuando sus transacciones en las agencias del Banco, a través de las máquinas ATM en cualquier de ellas, llamando a nuestro Call Center o a través de cualquier otro canal del Banco habilitado para realizar transacciones.
</p>
<p>
...
<p>
Banco Pichincha no será responsable por cualquier error cometido o por la información por usted ingresada para la realización de operaciones o transferencias a través de los canales electrónicos.
</p>
<p>
El Banco pondrá a su disposición a través de medios y canales electrónicos el registro de los últimos movimientos de sus Cuentas, considerándose efectuada una transacción desde el momento en que conste registrada en el canal electrónico. En caso de que usted no la objete dentro de los treinta (30) días calendario siguientes a la fecha de la transacción, se entenderá su conformidad con la información de los movimientos de las Cuentas. Cuando notifique a Banco Pichincha de un error que haya observado a través de los canales electrónicos, deberá proveernos, como mínimo, la siguiente información:
</p>
<p>
· Su nombre completo y alguna otra información que solicitemos para verificar su identidad
</p>
<p>
· Los números de cuenta de las cuentas involucradas
</p>
<p>
· Una descripción del error o de la cuenta sobre la que tenga dudas
</p>
<p>
· Una explicación, lo más clara posible, de la razón por la que cree que se trata de un error o por la que necesita más información
</p>
<p>
· La cantidad en dólares que comprende el posible error
</p>
<p>
No obstante las condiciones establecidas en esta sección, en caso de que cualquier contradicción con las condiciones establecidas en el contrato de la Apertura de Cuenta o de prestación del Servicio correspondiente, la resolución del error se ajustará a las condiciones de dicho contrato.
</p>
...
<p>
Autoriza expresa e inequívocamente además a Banco Pichincha C.A., divulgar a terceras partes información personal, de su cuenta o sobre las transferencias que realice, cuando sea necesario para:
</p>
<p>
a. Completar las transferencias efectuadas a través de canales electrónicos,
</p>
<p>
b. Comprobar la existencia y la condición de su cuenta,
</p>
<p>
c. Cumplir con las disposiciones de las autoridades competentes u órdenes judiciales,
</p>
<p>
d. Si usted lo solicita expresamente, y
</p>
<p>
e. Ofertarle productos y darle a conocer campañas comerciales de productos o servicios financieros o no financieros que podrían ser de su interés.
</p>
<p>
...
<p>
El Banco no asume ni podrá adjudicársele responsabilidad alguna, por daños o virus que puedan perjudicar su equipo, dispositivo o alguna otra propiedad, en relación con su acceso a los canales electrónicos o por su uso o por descargas que de estos hiciera.
</p>
<p>
...
<p>
Para información adicional relacionada con Banco Pichincha C.A. o alguna de sus subsidiarias, su centro de negocios y las localidades y horas de servicio de sus agencias, o de los productos y servicios que ofrece el Banco, acceda a los canales electrónicos o llámenos a los números arriba detallados. También puede visitar www.pichincha.com o alguna de nuestras agencias a nivel nacional.
</p>
<p>
...
<p>
Banco Pichincha C.A. se reserva el derecho de cancelar inmediatamente su acceso a los canales electrónicos:
</p>
<p>
· Si usted no cumpliera con los términos y condiciones impuestos por Banco Pichincha en este documento o cualquier otro contrato celebrado.
</p>
<p>
· Si Banco Pichincha estimara que hubo un uso no autorizado de los canales electrónicos.
</p>
<p>
· Si usted o una persona autorizada solicita la cancelación.
</p>
<p>
· Si sus cuentas han sido cerradas o se han cancelado los servicios por voluntad suya o por decisión de autoridad competente.
</p>
<p>
...
<p>
b. El uso de los canales electrónicos y el acceso a ellos está sujeto a las leyes de la República del Ecuador (excluyendo los conflictos entre principios legales) y a otras leyes y regulaciones aplicables.
</p>
<p>
c. En caso de que alguna provisión de este documento resultara inválida o inaplicable, las restantes provisiones del mismo permanecerán efectivas.
</p>
<p>
d. Banco Pichincha C.A. se reserva el derecho de iniciar cualquier acción legal a su disposición, en caso de que usted no pudiera cumplir con las disposiciones de este documento. Acciones correctivas pueden incluir la suspensión del acceso a los canales electrónicos y/o el cierre de cuentas relacionadas y/o afectadas.
</p>
<p>
