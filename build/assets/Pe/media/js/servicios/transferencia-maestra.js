...
// VARIABLES GLOBALES
  ...
  function buscar(pgSgt){
    ...
    var $aux = $('#loading').dialog({title:"Buscando tarjetas",modal: true, resizable:false, dialogClass: 'hide-close', close:function(){$aux.dialog('close');}, position: { my: "top"}  });
			...
			var dataRequest = JSON.stringify({ 'data-dni':$('#dni').val(), 'data-tjta':$('#nroTjta').val(), 'data-pg':pgSgt, 'data-paginas':serv_var.paginas, 'data-paginar':serv_var.paginar, ceo_name: ceo_cook });
