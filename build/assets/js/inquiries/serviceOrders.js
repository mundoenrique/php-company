...
$(function () {
  ...
  $('#system-info').on('click', '.get-otp', function () {
    $(this).html(loader).prop('disabled', true).removeClass('get-otp');
    getOtpService();
  });
  ...
  $('#system-info').on('click', '.viewOS', function () {
    ...
    if (form.valid()) {
      $(this).html(loader).prop('disabled', true).removeClass('viewOS');
      insertFormInput(true);
      $('.cover-spin').show();
...
function deleteBulk(oldID, inputSelected) {
  ...
  deleteBulkBtn.on('click', function () {
    ...
    if (formDeleteBulk.valid()) {
      insertFormInput(true);
      $(this).off('click').html(loader).prop('disabled', true).attr('id', oldID);
