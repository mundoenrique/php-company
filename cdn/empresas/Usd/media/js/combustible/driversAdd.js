...
function validar_campos() {
    ...
    $("#formAddEdit").validate({
        ...
        rules: {
            "dniDriver": {required: true, number: true},
            "user": {required: true, username: /^[a-z0-9_-]{6,16}$/i},
            "mail": {required: true, mail: /^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,4})+$/},
            "telf_mov": {required: true, number: true,  minlength: 10},
            "name1": {required: true, pattern: letter},
            "name2": {pattern: letter},
            "ape1": {required: true, pattern: letter},
            "ape2": {pattern: letter},
            "birthDay": {required: true, birth: /^\d{2}\/\d{2}\/\d{4}$/, getAge: true},
            "sex": {required: true}
        },
