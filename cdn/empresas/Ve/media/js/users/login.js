        ...
        if (user != '' && pass != '' && cookie != '') {
            ...
            $consulta.done(function(data) {
                ...
                if (data == "userold") {
                  ...
                  $('<div><h6>Estimado cliente:<br><br>Su empresa aún no ha sido incorporada al nuevo sistema <strong>Conexión Empresas Online</strong>, por esta razón, al pulsar "Aceptar", será direccionado nuevamente a Tebca/Servitebca Online.</h6></div>').dialog({
                    title: "Conexión Empresas Online",
                    modal: true,
                    maxWidth: 700,
                    maxHeight: 300,
                    ...
                    buttons: {
                      Aceptar: function() {
                        ...
                        $(this).dialog("destroy");
                        habilitar();
                        window.location.replace('https://online.bonus.com.ve/eolweb/loginContent.jsp');
                      }
                    }
                  });
                } else if (data == 'bloqueado') {
                    $('<div><h6>Usuario no disponible o inactivo. Solicite el reinicio de su clave enviando un correo a <strong>soporteempresas@tebca.com</strong> indicando su usuario. La nueva clave será enviada a su correo electrónico. <h4>Pulse "Aceptar" para continuar.<h4></h6></div>')
                        .dialog({
                            title: "Conexión Empresas Online",
                            modal: true,
                            maxWidth: 700,
