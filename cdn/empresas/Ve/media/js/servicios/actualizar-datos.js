$(function(){ // Document ready
	...
	$("#buscar-datos").on("click",function(){
			...
			$.post(baseURL+api+isoPais+'/servicios/actualizar-datos/buscar-datos',{"data-nombre":$('#nombre').val(),"data-status":estatus})
			.done(function(data){
	...
	$('#tabla-act-datos').on('click','#downXLS', function(){
		...
		$('form#formulario').empty();
    		...
    		$.post(baseURL+api+isoPais+"/servicios/actualizar-datos/downXLS",{"data-nomb":nomb,"data-fecha":fecha}).done(function(data){
    			$aux.dialog('destroy')
    			if(!data.ERROR){
    				$('form#formulario').empty();
